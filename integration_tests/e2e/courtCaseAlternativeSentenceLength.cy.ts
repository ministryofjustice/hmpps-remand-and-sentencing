...
context('Court Case Alternative Sentence Length Page', () => {
  ...
  beforeEach(() => {
    ...
    cy.visit('/person/A1234AB/add-court-case/0/appearance/0/alternative-overall-sentence-length')
  ...
  it('button to continue is displayed', () => {
    courtCaseAlternativeSentenceLengthPage.button().should('contain.text', 'Continue')
  })

  it('submitting without entering anything in the inputs results in an error', () => {
    courtCaseAlternativeSentenceLengthPage.button().click()
    courtCaseAlternativeSentenceLengthPage = Page.verifyOnPage(CourtCaseAlternativeSentenceLengthPage)
    courtCaseAlternativeSentenceLengthPage
      .errorSummary()
      .trimTextContent()
