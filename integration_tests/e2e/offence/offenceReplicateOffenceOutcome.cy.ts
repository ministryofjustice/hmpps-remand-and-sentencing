...
context('Replicate offence outcome Page', () => {
  let replicateOffenceOutcomePage: ReplicateOffenceOutcomePage
  beforeEach(() => {
    ...
    replicateOffenceOutcomePage = Page.verifyOnPage(ReplicateOffenceOutcomePage)
  })

  it('submitting no answer results in error', () => {
    replicateOffenceOutcomePage.continueButton().click()
    replicateOffenceOutcomePage = Page.verifyOnPage(ReplicateOffenceOutcomePage)
    replicateOffenceOutcomePage
      .errorSummary()
      .trimTextContent()
