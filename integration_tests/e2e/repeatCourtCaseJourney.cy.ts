...
context('Repeat Court Case journey', () => {
  ...
  it('repeat remand journey', () => {
    ...
    let offenceCheckOffenceAnswersPage = Page.verifyOnPage(OffenceCheckOffenceAnswersPageEdit)
    ...
    offenceCheckOffenceAnswersPage = Page.verifyOnPage(OffenceCheckOffenceAnswersPageEdit)
