...
export default {
    ...
    return stubFor({
      ...
      response: {
        ...
        jsonBody: (customResponseBody as object[]) ?? [
          ...
          {
            code: 'OATC',
            title: 'Offence aggravated by a terrorist connection',
            description: 'Offence aggravated by a terrorist connection',
            displayOrder: 10,
          },
        ],
      },
  ...
  stubEmptySearchSentenceTypes: (): SuperAgentRequest => {
    return stubFor({
      request: {
        method: 'GET',
        urlPath: '/remand-and-sentencing-api/sentence-type/search',
  ...
  stubCreateAppealHearing: (): SuperAgentRequest => {
    return stubFor({
      request: {
        method: 'PUT',
  ...
  verifyCreateAppealHearingRequest: (): Promise<number> => {
    return verifyRequest({
  ...
  stubGetCourtCaseAppealLatest: (): SuperAgentRequest => {
    return stubFor({
      request: {
        method: 'GET',
