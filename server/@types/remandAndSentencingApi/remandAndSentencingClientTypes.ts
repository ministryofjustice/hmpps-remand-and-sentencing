...
export type UpdateCourtCaseStatus = components['schemas']['UpdateCourtCaseStatus']
...
export type PageCourtCaseAppearance = components['schemas']['CourtAppearance']
...
export type CourtAppearanceSubtype = components['schemas']['CourtAppearanceSubtype']
