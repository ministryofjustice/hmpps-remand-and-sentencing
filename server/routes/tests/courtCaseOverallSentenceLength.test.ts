...
describe('GET Court Case Sentence Length', () => {
  it('should render page on new journey', () => {
    ...
    return request(app)
      .get('/person/A1234AB/add-court-case/0/add-court-appearance/0/sentencing/overall-sentence-length')
      ...
      .expect(res => {
        ...
        const caption = $('[data-qa=warrant-information-caption]').text()
        expect(caption).toContain('Add overall warrant information')
      })
  })
})
