...
describe('GET Sentence correct many alternative period lengths', () => {
  it('should render page', () => {
    ...
    return request(app)
      .get(
        '/person/A1234AB/edit-court-case/0/edit-court-appearance/0/offences/0/correct-many-alternative-period-length?periodLengthType=SENTENCE_LENGTH',
      )
