...
describe('GET Sentencing making sentence concurrent', () => {
  it('should render page on new journey', () => {
    ...
    return request(app)
      .get('/person/A1234AB/add-court-case/0/add-court-appearance/0/sentencing/offences/0/making-sentence-concurrent')
      ...
      .expect(res => {
        ...
        expect(continueButton).toContain('Yes, make the sentence concurrent')
      })
  })
})
